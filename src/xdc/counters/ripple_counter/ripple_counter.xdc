...
#Ripple Counter IO Configuration
create_clock -add -name cnt_clk -period 5000.00 -waveform {0 2500} [get_ports { clk }];

set_property -dict { PACKAGE_PIN D9   IOSTANDARD LVCMOS33     } [get_ports { clk }]; #
set_property -dict { PACKAGE_PIN A10  IOSTANDARD LVCMOS33     } [get_ports { clr_n }]; #
set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS33     } [get_ports { clkpol }]; #
set_property -dict { PACKAGE_PIN B8   IOSTANDARD LVCMOS33     } [get_ports { auto }]; #
set_property -dict { PACKAGE_PIN A8   IOSTANDARD LVCMOS33     } [get_ports { max_count[0] }]; #
set_property -dict { PACKAGE_PIN C11  IOSTANDARD LVCMOS33     } [get_ports { max_count[1] }]; #
set_property -dict { PACKAGE_PIN C10  IOSTANDARD LVCMOS33     } [get_ports { max_count[2] }]; #
set_property -dict { PACKAGE_PIN G6   IOSTANDARD LVCMOS33     } [get_ports { count[0] }]; #
set_property -dict { PACKAGE_PIN G3   IOSTANDARD LVCMOS33     } [get_ports { count[1] }]; #
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33     } [get_ports { count[2] }]; #
set_property -dict { PACKAGE_PIN H5   IOSTANDARD LVCMOS33     } [get_ports { count_n[0] }]; #
set_property -dict { PACKAGE_PIN J5   IOSTANDARD LVCMOS33     } [get_ports { count_n[1] }]; #
set_property -dict { PACKAGE_PIN T9   IOSTANDARD LVCMOS33     } [get_ports { count_n[2] }]; #
set_property -dict { PACKAGE_PIN E1   IOSTANDARD LVCMOS33     } [get_ports { counted_max }]; #