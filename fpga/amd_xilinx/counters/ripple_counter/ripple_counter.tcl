...
#
# ripple_counter.tcl: Tcl script for re-creating project 'ripple_counter'
#
# Generated by Vivado on Sun Jan 07 12:03:15 IST 2024
...
#
# 1. This project restoration tcl script (ripple_counter.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/run/media/kavin_raj/BackupPlus/workspace/learnVLSI/miniProjects/IC2021/fpga/amd_xilinx/counters/ripple_counter/ripple_counter.srcs/utils_1/imports/synth_1/ripple_counter.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/run/media/kavin_raj/BackupPlus/workspace/learnVLSI/miniProjects/IC2021/src/rtl/counters/ripple_counter/ripple_counter.sv"
#    "/run/media/kavin_raj/BackupPlus/workspace/learnVLSI/miniProjects/IC2021/src/xdc/counters/ripple_counter/ripple_counter.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ripple_counter.srcs/utils_1/imports/synth_1/ripple_counter.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../../src/rtl/counters/ripple_counter/ripple_counter.sv"]"\
 "[file normalize "$origin_dir/../../../../src/xdc/counters/ripple_counter/ripple_counter.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "ripple_counter"
...
set script_file "ripple_counter.tcl"
...
set file "$origin_dir/../../../../src/rtl/counters/ripple_counter/ripple_counter.sv"
...
set_property -name "top" -value "ripple_counter" -objects $obj
...
set file "[file normalize "$origin_dir/../../../../src/xdc/counters/ripple_counter/ripple_counter.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../../src/xdc/counters/ripple_counter/ripple_counter.xdc"
set file [file normalize $file]
...
set file "synth_1/ripple_counter.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/ripple_counter.srcs/utils_1/imports/synth_1/ripple_counter.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ripple_counter.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ripple_counter.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ripple_counter.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
